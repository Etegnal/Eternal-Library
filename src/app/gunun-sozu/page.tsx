        ...
        <form onSubmit={handleSearchSubmit} className="flex items-center gap-2 w-full sm:w-auto">
          <div className="relative flex-1 sm:w-48">
            <input
              ...
              className="w-full pl-9 pr-3 py-2 text-sm rounded-xl border border-amber-200 text-cozy-coffee bg-amber-50/50 focus:outline-none focus:border-cozy-amber"
            />
        ...
        {loading ? (
          ...
          <div className="space-y-6">
            ...
            <div className="pt-4 border-t border-dashed border-cozy-parchment-border flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              ...
              <button
                onClick={handleCopy}
                className="flex items-center gap-2 text-xs bg-cozy-amber/10 hover:bg-cozy-amber/20 text-cozy-amber-dark px-4 py-2 rounded-xl font-semibold border border-cozy-amber/30 transition-all self-end sm:self-auto"
              >
                {copied ? (
                  <>
