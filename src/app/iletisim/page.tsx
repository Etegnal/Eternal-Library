...
export default function ContactPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 pt-32 pb-16 space-y-10">
      ...
      <div className="grid grid-cols-2 gap-3 max-w-md mx-auto p-1.5 bg-[#23120A]/10 rounded-2xl border border-amber-900/10">
        <button
          type="button"
      ...
      <div className="p-8 sm:p-12 rounded-3xl bg-[#FFFDF9] border-2 border-[#E5D5B7] shadow-fire space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-cozy-coffee">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-bold uppercase mb-1 text-[#362215]">Adınız Soyadınız</label>
              <input
                type="text"
                required
                placeholder="Adınız..."
            ...
            <div>
              <label className="block text-xs font-bold uppercase mb-1 text-[#362215]">E-Posta Adresiniz</label>
              <input
                type="email"
                required
          ...
          <div>
            <label className="block text-xs font-bold uppercase mb-1 text-[#362215]">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-2.5 rounded-xl border border-amber-200 text-sm focus:outline-none focus:border-cozy-amber bg-amber-50/50 font-serif leading-relaxed"
            />
          </div>
