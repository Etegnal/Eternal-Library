...
export default function MiniPlayer() {
  ...
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 sm:left-auto sm:right-6 sm:translate-x-0 z-50 w-[calc(100vw-2rem)] sm:w-auto max-w-lg transition-all duration-500 animate-fadeIn">
      ...
      <div className="w-full sm:w-auto flex items-center justify-between gap-2 sm:gap-3 p-2 sm:p-2.5 px-3 bg-[#120e0b]/95 backdrop-blur-md border border-amber-500/30 hover:border-amber-500/50 rounded-2xl shadow-2xl shadow-black/80 transition-all duration-300 group">
